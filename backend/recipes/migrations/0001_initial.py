# Generated by Django 3.2.3 on 2025-03-30 16:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Время приготовления должно быть больше 0'), django.core.validators.MaxValueValidator(32767, message='Время приготовления должно быть меньше 32767')], verbose_name='Время приготовления')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Количество должно быть больше 0'), django.core.validators.MaxValueValidator(32767, message='Количество должно быть меньше 32767')], verbose_name='Количество')),
