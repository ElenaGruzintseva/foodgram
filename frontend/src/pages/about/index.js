    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/ElenaGruzintseva/foodgram" className={styles.textLink}>Foodgram</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/ElenaGruzintseva" className={styles.textLink}>Елена Грузинцева</a>
            </p>
          </div>
        </aside>
      </div>
